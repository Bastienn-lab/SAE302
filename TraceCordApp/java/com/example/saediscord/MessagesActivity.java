...
public class MessagesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        colorAnimation.addUpdateListener(animator -> {
            ...
            userNameText.setTextColor(invertColor(color));
            statsMessagesSent.setTextColor(invertColor(color));
            statsAvgMessageLength.setTextColor(invertColor(color));
            statsMostRepliedUser.setTextColor(invertColor(color));
        });
